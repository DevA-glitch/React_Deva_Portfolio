  ...
  <section class="mb-32 text-gray-800">
    <div class="flex flex-wrap">
      <div class="grow-0 shrink-0 basis-auto mb-6 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
        ...
        <p class="text-gray-500 mb-2">Coimbature</p>
        <p class="text-gray-500 mb-2">Ganapathy</p>
        <p class="text-gray-500 mb-2">devarajan.1011@gmail.com</p>
      </div>
      <div class="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full md:w-6/12 px-3 lg:px-6">
        <form action='https://getform.io/f/5d3602c3-cca8-42ed-afd5-ffc18ef4b045' method='POST'>
          <div class="form-group mb-6">
            <input type="text" name='text' class="form-control block
              w-full
              px-3
              py-1.5
              text-base
