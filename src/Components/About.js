...
const About = () => {
  return (
    <div className='py-20 bg-gradient-to-b from-stone-100 duration-500 max-md:w-max' name='ABOUT'>
      ...
      <div className='px-20 py-5 flex items-center justify-center gap-20 max-md:flex-col '>
        ...
        <div className='font-mono text-sm mt-7'>
          <h3 className='text-3xl mb-5'>Want to know me</h3>
            <p className='mb-2 w-[40rem] max-md:w-[30rem]'>I'm a React Frontend Developer whose whole interest is building interactive, accessible, and responsive websites. To create an user friendly web-development. <span className=' font-semibold'>Foucing on improving and adding my skilld related to the field</span></p>
            
            <p className=' w-[40rem] max-md:w-[30rem]'>I'm currently open to Job opportunities where I can contribute to your business and make your users happy. Contact me if you're interested in having a taste of my skills.</p>
            <div className='mt-4'>
